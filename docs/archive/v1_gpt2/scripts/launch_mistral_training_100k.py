...
Prépare les données, tokenise, puis lance l'entraînement 100k→200k.
"""
import subprocess
import sys
...
def main():
    print("🚀 LANCEMENT AUTOMATIQUE ENTRAÎNEMENT MISTRAL 100k→200k")
    print("=" * 60)
    ...
    print("\n🔄 Étape 3: Lancement entraînement Mistral 100k→200k")
    print("   Configuration:")
    ...
    print("   - Run: french_medium_mistral_200k")
    print("   - Steps: 100000 → 200000 (100k steps)")
    print("   - Batch size: 4")
    ...
    cmd = [
        ...
        "--run-name", "french_medium_mistral_200k",
    ...
    print("   tail -f trained_models/runs/french_medium_mistral_200k/metrics.jsonl")
    print("   Ou utiliser le dashboard: docker-compose up -d backend frontend && open http://localhost:5174")
    ...
    try:
        ...
        print("\n📊 Suivi:")
        print("   - Logs: trained_models/runs/french_medium_mistral_200k/")
