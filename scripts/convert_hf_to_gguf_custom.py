...
# Add local llama.cpp gguf-py to path
sys.path.insert(0, str(Path("/home/vincent/llama.cpp/gguf-py").resolve()))
...
class TextModel(ModelBase):
    ...
    def get_vocab_base_pre(self, tokenizer) -> str:
        ...
        if res is None:
            logger.warning("WARNING: Pre-tokenizer not recognized, forcing 'gpt-2' fallback")
            return "gpt-2"
